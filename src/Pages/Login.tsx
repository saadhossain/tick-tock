        ...
        <div className='w-10/12 mx-auto flex justify-between items-center mt-10 gap-10'>
            ...
            <div className="w-2/4 p-8 space-y-3 rounded-xl bg-secondary dark:text-gray-100">
                ...
                <form className="space-y-6 ng-untouched ng-pristine ng-valid text-white">
                    ...
                    <button className="block w-full p-3 text-center rounded-lg bg-primary hover:bg-purpledark duration-500 ease-in-out text-white font-semibold bg-se">Sign in</button>
                </form>
                ...
                <p className="text-md text-center sm:px-6 ">Don't have an account?
                    <Link to='/register' className="font-semibold ml-2">Sign up</Link>
                </p>
            </div>
            {/* Login/Registe Image */}
